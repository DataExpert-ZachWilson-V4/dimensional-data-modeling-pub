CREATE OR REPLACE TABLE jb19881.actors_history_scd (
    actor varchar NOT NULL COMMENT 'actor''s name',
    -- actor_id varchar NOT NULL COMMENT 'Unique identifier for each actor, part of the primary key in actor_films dataset.',
    quality_class varchar,
    is_active boolean,
    start_date integer COMMENT 'Marks the beginning of a particular state (quality_class/is_active) needed for SCD Type 2 tables.',
    end_date integer COMMENT 'Marks the end of a particular state (quality_class/is_active) needed for SCD Type 2 tables.',
